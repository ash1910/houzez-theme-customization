...
class MEstate_Register extends \Elementor\Widget_Base { 

    public function get_name() {
        return 'mestate_register';
    }

    public function get_title() {
        return __( 'MEstate Register', 'houzez' );
    }
    ...
    protected function render() {
        ...
        get_template_part('elementor-widgets/template-parts/mestate-register-v1');     
