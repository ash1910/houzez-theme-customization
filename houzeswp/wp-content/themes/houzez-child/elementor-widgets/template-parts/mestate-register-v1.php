          ...
          <div class="container-fluid container-fluid--sm">
                ...
                <?php if( !is_user_logged_in() || \Elementor\Plugin::$instance->editor->is_edit_mode() ) { ?>
                  ...
                  <form class="ms-form__main">
                    ...
                    <div class="ms-input ms-input--serach">
                      <input name="first_name" type="text" placeholder="<?php esc_html_e('First Name','houzez'); ?>" />
                    </div>
                    <?php } ?>
                    <?php if( houzez_option('register_last_name', 0) == 1 ) { ?>
                    <div class="ms-input ms-input--serach">
                      <input name="last_name" type="text" placeholder="<?php esc_html_e('Last Name','houzez'); ?>" />
                    </div>
                    <?php } ?>
                    <div class="ms-input ms-input--serach">
                      <input name="username" type="text" placeholder="<?php esc_html_e('Username','houzez'); ?>" />
                    </div>
                    <div class="ms-input ms-input--serach username-field">
                      <input name="useremail" type="email" placeholder="<?php esc_html_e('Email','houzez'); ?>" />
                    </div>
                    <?php if( houzez_option('register_mobile', 0) == 1 ) { ?>
                    <div class="ms-input ms-input--serach">
                      <input name="phone_number" type="number" placeholder="<?php esc_html_e('Phone','houzez'); ?>" />
                    </div>
                    <?php } ?>
                    ...
                    <div class="ms-input ms-input--agree">
                      <div class="form-check">
                        ...
                        <?php echo sprintf( __( 'I agree with your <a class="ms-form__forgot-pass" target="_blank" href="%s">Terms & Conditions</a>', 'houzez' ), 
            get_permalink(houzez_option('login_terms_condition') )); ?>
                    ...
                    <div class="ms-form__submit">
                      ...
                      <button type="submit" class="ms-btn" id="houzez-register-btn">
                        Sign Up
