...
<!-- card 1 -->
<div class="ms-apartments-main__card ms-apartments-main__card--3 ms-apartments-main__card--4">
    ...
    <div class="ms-apartments-main__card__content">
        ...
        <!-- price -->
        <div class="ms-apartments-main____card__price" style="justify-content: flex-start;">
            <p>Starting Price</p>
            <h6><?php 
