        ...
        <div class="dashboard-header-wrap">
            <div class="d-flex align-items-center">
                <div class="dashboard-header-left flex-grow-1">
                    ...
                    <h1><?php 
                    if($add_verification == 1){
                        echo houzez_option('dsh_verification', 'Verification ');
                        if( isset($_GET['edit_property']) ){
                            echo 'of property "'. get_the_title($_GET['edit_property']). '"';
                        }
                        
                    }
                    else{
                        echo houzez_option('dsh_create_listing', 'Create a Listing'); 
                    }
                    ?></h1>
