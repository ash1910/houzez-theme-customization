...
<div class="save-search-form-wrap">
    ...
    <?php } ?>
        ...
        <button class="btn btn-listing save_search_click save-search-btn" type="button">
            <?php get_template_part('template-parts/loader'); ?>
            <i class="btn-icon"><?php include get_stylesheet_directory() . '/assets/images/alert_icon.svg'; ?></i>
            <?php echo houzez_option('srh_btn_get_alert', 'Get Alert'); ?>
        </button>
    <?php if( !houzez_is_half_map() ) { ?>
    </form>
    <?php } ?>
