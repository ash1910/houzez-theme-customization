...
if( !empty( $developer_skype ) || !empty( $developer_facebook ) || !empty( $developer_instagram ) || !empty( $developer_twitter ) || !empty( $developer_linkedin ) || !empty( $developer_googleplus ) || !empty( $developer_youtube ) || !empty( $developer_pinterest ) || !empty( $developer_vimeo ) || !empty( $developer_whatsapp ) || !empty( $developer_tiktok ) || !empty( $developer_telegram ) || !empty( $developer_zillow ) || !empty( $developer_realtor_com ) ) {
?>
