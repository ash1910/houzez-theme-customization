...
if(houzez_option('developer_tabs', 1)) {
    ...
    $developer_detail_tab_1 = houzez_option('developer_detail_tab_1');
    $developer_detail_tab_2 = houzez_option('developer_detail_tab_2');

    if(!empty($developer_detail_tab_1) || !empty($developer_detail_tab_2)) {

    $tab_1 = houzez_get_term_by( 'term_id', $developer_detail_tab_1, 'property_status' );
    $tab_2 = houzez_get_term_by( 'term_id', $developer_detail_tab_2, 'property_status' );
