<?php 
global $houzez_local;
$des = get_post_meta(get_the_ID(), 'fave_developer_des', true);
$position = get_post_meta(get_the_ID(), 'fave_developer_position', true);
$company = get_post_meta(get_the_ID(), 'fave_developer_company', true);
$logo_id = get_post_meta(get_the_ID(), 'fave_developer_logo', true);
?>
