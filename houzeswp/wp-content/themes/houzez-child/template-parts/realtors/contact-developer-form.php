...
} else if ( is_singular( 'houzez_developer' ) ) {
    global $post;
    $target_email = get_post_meta( $post->ID, 'fave_developer_email', true );
    $developer_id = $post->ID;
    $developer_type  = 'developer_info';
    $source_link = get_permalink();
    $name = get_the_title();

    $form_shortcode = houzez_option('contact_form_developer_detail');
                ...
                <div class="property-form-wrap">
                    ...
                    <div class="property-form clearfix">
                        ...
                        <form method="post">
                            ...
                            <input type="hidden" name="developer_id" value="<?php echo intval($developer_id)?>">
                            <input type="hidden" name="developer_type" value="<?php echo esc_attr($developer_type)?>">
