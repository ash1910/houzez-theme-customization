...
<div class="form-group">
	<label for="prop_price">
		...
		if( houzez_is_developer()  ){
			echo houzez_option('cl_selling_price', 'Selling Price').houzez_required_field('sale_rent_price'); 
		}
		else{
			echo houzez_option('cl_sale_price', 'Sale or Rent Price').houzez_required_field('sale_rent_price'); 
		}
		?>	
	</label>
