...
<div id="sub-properties" class="dashboard-content-block-wrap <?php echo esc_attr($is_multi_steps);?>">
	...
	<div class="dashboard-content-block">
				...
				<div class="row">
					...
					<div class="col-md-6 col-sm-12">
						<div class="form-group">
                            ...
                            <input value="<?php echo sanitize_text_field( $multi_unit['fave_mu_beds'] ); ?>" name="fave_multi_units[<?php echo intval($count); ?>][fave_mu_beds]" type="text" class="form-control" placeholder="<?php echo houzez_option('cl_subl_bedrooms_plac', 'Enter the number of bedrooms');?>">
					...
					<div class="col-md-6 col-sm-12">
						<div class="form-group">
                            ...
                            <input value="<?php echo sanitize_text_field( $multi_unit['fave_mu_size'] ); ?>" name="fave_multi_units[<?php echo intval($count); ?>][fave_mu_size]" type="text" class="form-control" placeholder="<?php echo houzez_option('cl_subl_size_plac', 'Enter the property size');?>">
						</div>
					</div><!-- col-md-6 col-sm-12 -->
					<!-- <div class="col-md-6 col-sm-12">
						<div class="form-group">
				...
				<div class="row">
					...
					<div class="col-md-6 col-sm-12">
						<div class="form-group">
		                    ...
		                    <input name="fave_multi_units[0][fave_mu_beds]" type="text" class="form-control" placeholder="<?php echo houzez_option('cl_subl_bedrooms_plac', 'Enter the number of bedrooms');?>">
						</div>
					</div><!-- col-md-6 col-sm-12 -->
					<div class="col-md-6 col-sm-12">
						<div class="form-group">
					...
					<div class="col-md-6 col-sm-12">
						<div class="form-group">
		                    ...
		                    <input name="fave_multi_units[0][fave_mu_size]" type="text" class="form-control" placeholder="<?php echo houzez_option('cl_subl_size_plac', 'Enter the property size');?>">
						</div>
					</div><!-- col-md-6 col-sm-12 -->
					<!-- <div class="col-md-6 col-sm-12">
						<div class="form-group">
		...
		<button id="add-subproperty-row-custom" data-increment="<?php echo esc_attr($data_increment); ?>" class="btn btn-primary btn-left-icon"><i class="houzez-icon icon-add-circle"></i> <?php esc_html_e('Add New', 'houzez'); ?></button>
