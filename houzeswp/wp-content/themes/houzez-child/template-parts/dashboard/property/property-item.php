			...
			<div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                ...
                if( $is_user_can_manage ) {
                    ...
                    if ( in_array( $post->post_status, array( 'pending', 'disapproved' ) ) ) { 
                        echo '<a href="#" data-propid="'.intval( $post->ID ).'" data-type="approve" class="dropdown-item houzez-prop-action-js_custom"><strong>' . esc_html__('Approve', 'houzez') . '</strong></a>';
                    }

                    if ( in_array( $post->post_status, array( 'pending', 'publish' ) ) ) { 
                        echo '<a href="#" data-propid="'.intval( $post->ID ).'" data-type="disapprove" class="dropdown-item houzez-prop-action-js_custom"><strong>' . esc_html__('Disapproved', 'houzez') . '</strong></a>';
                    }

                    if ( in_array( $post->post_status, array( 'publish' ) ) && ! $fave_featured ) { 
                        echo '<a href="#" data-propid="'.intval( $post->ID ).'" data-type="set_featured" class="dropdown-item houzez-prop-action-js_custom"><strong>' . esc_html__('Mark as Featured', 'houzez') . '</strong></a>';
                    }

                    if ( in_array( $post->post_status, array( 'publish' ) ) && $fave_featured ) { 
                        echo '<a href="#" data-propid="'.intval( $post->ID ).'" data-type="remove_featured" class="dropdown-item houzez-prop-action-js_custom"><strong>' . esc_html__('Remove from Featured', 'houzez') . '</strong></a>';
                    }

                    if ( in_array( $post->post_status, array( 'publish' ) ) ) { 
                        echo '<a href="#" data-propid="'.intval( $post->ID ).'" data-type="expire" class="dropdown-item houzez-prop-action-js_custom">' . esc_html__('Mark as Expired', 'houzez') . '</a>';
                    }

                    if ( in_array( $post->post_status, array( 'expired', 'houzez_sold', 'draft' ) ) ) { 
                        echo '<a href="#" data-propid="'.intval( $post->ID ).'" data-type="publish" class="dropdown-item houzez-prop-action-js_custom">' . esc_html__('Publish', 'houzez') . '</a>';
                    }
