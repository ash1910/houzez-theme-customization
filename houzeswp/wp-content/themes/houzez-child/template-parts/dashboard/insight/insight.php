            ...
            <div class="dashboard-table-insight-wrap">
                ...
                <tbody>
                    ...
                    while ($prop_qry->have_posts()): $prop_qry->the_post(); 
                        ...
                        $activities_stats = houzez_views_user_stats($userID, $activities_start_date, $activities_end_date, $listing_id);
                    ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-primary btn-advance-state" href="/insights?listing_id=<?php echo $listing_id;?>">Advance States</a>
                        </td>
                    </tr>
