...
Redux::setSection( $houzez_opt_name, array(
    ...
    'fields'    => array(
        array(
            ...
            'desc'   => esc_html__( '%user_login_firstname as firstname %user_login_register as username, %user_pass_register as user password, %user_email_register as new user email, %user_phone_register as phone number', 'houzez' )
        ),
        ...
        array(
            ...
            'desc'     => '',
            'default'  => esc_html__('Hi %user_login_firstname,
...
Listing Url: %listing_url", 'houzez'),
        ...
        array(
            ...
            'subtitle' => esc_html__('You can use %user_firstname as firstname, %listing_title as listing title, %listing_url as listing link', 'houzez'),
            'desc'   => ''
        ),
        ...
        array(
            ...
            'desc'     => '',
            'default'  => esc_html__("Hi %user_firstname,
...
Redux::setSection( $houzez_opt_name, array(
    ...
    'fields'    => array(
        array(
            ...
            'subtitle' => esc_html__('you can use %user_firstname as firstname, %invoice_no as invoice number, %listing_title as listing title, %listing_url as listing link and %listing_id as listing id', 'houzez'),
            'desc'   => ''
        ),
        array(
