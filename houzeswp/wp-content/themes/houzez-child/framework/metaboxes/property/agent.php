	...
	$fields = array(
		array(
            ...
            'options' => array(
                ...
                'developer_info' => houzez_option('cl_developer_info', 'Developer Info (Choose developer from the list below)'),
        ...
        array(
            'name'        => houzez_option('cl_developer_info_plac', 'Select an Developer'),
            'id'          => "{$houzez_prefix}developers",
            'type'        => 'post',
            'ajax' => true,
            'post_type'   => 'houzez_developer',
            'field_type'  => 'select_advanced',
            'placeholder' => esc_html__('Select an Developer', 'houzez'),
            'query_args'  => array(
                'post_status'    => 'publish',
                'posts_per_page' => 10,
            ),
            'tab' => 'agent',
            'columns' => 12,
            'visible' => array( $houzez_prefix.'agent_display_option', '=', 'developer_info' ),
            'multiple' => $is_multi_agents
        ),
        array(
