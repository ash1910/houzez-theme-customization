...
<div
    class="ms-apartments-main__sidebar__single ms-apartments-main__sidebar__single--broker <?php echo $newprojects == 1 ? '' : 'ms-apartments-main__sidebar__single--broker-2'; ?> <?php echo isset($agent_is_top_broker) && $agent_is_top_broker == 1 ? 'ms-apartments-main__sidebar__single--broker-top' : ''; ?>">
    ...
    <div class="ms-apartments-main__card--2">
        ...
        <ul class="ms-apartments-main____card__button-list">
            ...
            <li>
                <a href="javascript:void(0)" data-link="tel:<?php echo esc_attr($agent_number_call); ?>" class="ms-btn ms-btn--bordered hz-call-popup-js tracking_view" data-type="c" data-prop_id="<?php echo esc_attr($post->ID);?>" data-model-id="email-popup-<?php echo esc_attr($post->ID).'-'.$random_token; ?>">
