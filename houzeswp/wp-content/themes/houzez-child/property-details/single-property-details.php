                ...
                <div class="ms-apartments-main__section">
                    ...
                    <div class="ms-apartments-main__card__wrapper">
                        ...
                        <div class="ms-apartments-main__card ms-apartments-main__card--list">
                            ...
                            <div class="ms-apartments-main__card__thumbnail">
                                ...
                                <div class="ms-apartments-main__card__thumbnail__footer">
                                    <span>Listed 3 month ago</span>
                                </div>
                            </div>
                            <div class="ms-apartments-main__card__content">
                                <h5>Elysian Villas</h5>
                                <a href="#">
                                    <i class="icon-location_grey"></i>
                                    Ajman, United Arab Emirates</a>
                                <!-- price -->
                                <div class="ms-apartments-main____card__price">
                                    <h6>AED 500.00 <span>House</span></h6>
                                    <a href="top-broker.html"><img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/apartments/broker/2.png" alt="" />
                                ...
                                <ul class="ms-apartments-main____card__button-list">
                                    ...
                                    <li>
                                        <a href="" class="ms-btn ms-btn--bordered">
                                            <svg width="21" height="21" viewBox="0 0 21 21" fill="none"
                                                ...
                                                <path
                                                    d="M14.6615 8L12.0531 10.0833C11.1948 10.7667 9.78645 10.7667 8.92812 10.0833L6.32812 8"
                                                    stroke="#1B1B1B" stroke-width="1.2" stroke-miterlimit="10" stroke-linecap="round"
                                                    stroke-linejoin="round" />
                                            </svg>
                                            Email</a>
                                    ...
                                    <li>
                                        <a href="" class="ms-btn ms-btn--bordered">
                                            <svg width="21" height="21" viewBox="0 0 21 21" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <mask id="mask0_3124_517" style="mask-type: luminance" maskUnits="userSpaceOnUse" x="0"
                        ...
                        <div class="ms-apartments-main__card ms-apartments-main__card--list">
                            ...
                            <div class="ms-apartments-main__card__thumbnail">
                                <div class="ms-apartments-main__card__thumbnail__img">
                                    <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/apartments/card/6.png" alt="" />
                                </div>
                                <div class="ms-apartments-main__card__thumbnail__header">
                                    <div class="ms-apartments-main__card__thumbnail__status">
                                        <i class="icon-verified-1"></i> verified
                                ...
                                <div class="ms-apartments-main__card__thumbnail__footer">
                                    <span>Listed 8 month ago</span>
                                </div>
                            </div>
                            <div class="ms-apartments-main__card__content">
                                <h5>The Majestic Grove Luxury Estate</h5>
                                <a href="#">
                                    <i class="icon-location_grey"></i>
                                    Ajman, United Arab Emirates</a>
                                <!-- price -->
                                <div class="ms-apartments-main____card__price">
                                    <h6>AED 600.00 <span>House</span></h6>
                                </div>
                                <!-- details list -->
                                <ul class="ms-apartments-main____card__details-list">
                                    <li><i class="icon-bed"> </i>3 Beds</li>
                        ...
                        <div class="ms-apartments-main__card ms-apartments-main__card--list">
                            ...
                            <div class="ms-apartments-main__card__thumbnail">
                                <div class="ms-apartments-main__card__thumbnail__img">
                                    <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/apartments/card/4.png" alt="" />
                                </div>
                                <div class="ms-apartments-main__card__thumbnail__header">
                                    <div class="ms-apartments-main__card__thumbnail__status">
                                        <i class="icon-verified-1"></i> verified
                                ...
                                <div class="ms-apartments-main__card__thumbnail__footer">
                                    <span>Listed 6 month ago</span>
                                </div>
                            </div>
                            <div class="ms-apartments-main__card__content">
                                <h5>Regal Ridge Villas</h5>
                                <a href="#">
                                    <i class="icon-location_grey"></i>
                                    Ajman, United Arab Emirates</a>
                                <!-- price -->
                                <div class="ms-apartments-main____card__price">
                                    <h6>AED 700.00 <span>House</span></h6>
                                    <a href="top-broker.html"><img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/apartments/broker/3.png" alt="" />
                                        <span>TopBroker</span></a>
                                </div>
                                <!-- details list -->
                                <ul class="ms-apartments-main____card__details-list">
