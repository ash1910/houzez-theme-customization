...
if( !function_exists('houzez_property_blog_search') ) {
    function houzez_property_blog_search() {
        $search_form = '<!-- search -->
                <form action="'.home_url().'" method="get" class="ms-filter__modal__form ms-filter__modal__form--search ms-filter__modal__form--search-hero ms-apartments-main__sidebar__single d-block d-md-none">
                        ...
                        <div class="ms-input__wrapper__inner">
                            <div class="ms-input ms-input--serach">
                                ...
                                <input type="search" placeholder="Search Location" class="ms-hero__search-loaction"
                                    name="s" value="'.get_search_query().'" id="ms-hero__search-loaction" />
                            </div>
                        </div>
                    </div>
                </form>';
