...
(function ($) {
  ...
  // portfolio slider
  const portfolioSlides = document.querySelectorAll(".ms-portfolio__wrap");
  ...
  // portfolio
  var portfolioSlider = new Swiper(".ms-portfolio__slider", {
    slidesPerView: 1.4,
    spaceBetween: 12,
    centeredSlides: true,
    loop: true,
  ...
  // appartment
  function useAppartmentSlider() {
    const appartmentSlider = new Swiper(".ms-appartments__slider", {
      slidesPerView: 1.5,
      spaceBetween: 20,
      centeredSlides: true,
      loop: true,
  ...
  tabs.forEach((tab) => {
    tab.addEventListener("shown.bs.tab", (e) => {
      ...
      useAppartmentSlider(); // Update Swiper when the tab is shown
    });
  });
  // sticky header
  // Sticky Js
